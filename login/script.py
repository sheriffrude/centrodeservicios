...
# Función principal que se ejecutará en la tarea de Celery
def main():
    ...
    try:
        ...
        INSERT INTO llegada_animales (
            ...
            novedad_tiempo_desembarque, tiempo_espera, novedad_tiempo_espera, muertos_desembarque, tiquete_desembarque,
            muertos_transporte, tiquete_transporte, muertos_reposo, tiquete_reposo, 
            lesionados, lesiones, tiquete_lesiones, agitados, tiquetes_agitados, 
            ...
            responsable_desembarque, granja, placa, granjaID, placaID
